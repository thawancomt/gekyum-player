...
export default function AlbumTrack({ data }: MusicItemProps) {
       ...
       const { current, is_playing, actions: { play_track } } = usePlayer();
              ...
              >
                     ...
                     <div className="flex items-center gap-6 font-mono tracking-tight text-xs">
                            ...
                            <span className={cn(
                                   ...
                                   isCurrentTrack && "text-orange-500 font-bold" // Um único ponto de cor industrial se estiver ativo
                            )}>
                                   {isThisTrackPlaying ? "►" : formattedIndex}
                            </span>
